...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final regisTrationField = TextFormField(
        ...
        keyboardType: TextInputType.name,
        validator: (value) {
          if (value!.startsWith('201') && value.length == 10) {
            return null;
          }
    ...
    final emailField = TextFormField(
        ...
        validator: (value) {
          ...
          //TODO: check if the mail is valid or not
  ...
  //user creation,signup,creating user document in firestore
        ...
        await _auth
          ...
          Navigator.of(context).push(PageTransition(
              child: Verify(
                ...
                reg: regEditingController.text,
                dept: dept,
                studentType: widget.studentType,
                teacherName: widget.teacherName,
                teacherEmail: widget.teacherEmail,
                teacherDept: widget.teacherDept,
              ),
